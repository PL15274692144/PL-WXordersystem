...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        List<Orders> ordersList = orderMapper.list(userId);

        if(ordersList.get(ordersList.size()-1).getStatus() == Orders.PENDING_PAYMENT){

            throw new OrderBusinessException("您当前有订单未支付，请先支付或取消订单后再操作.");
    ...
    public void userCancelById(Long id) throws Exception{
        ...
        //订单状态  1代付款 2待结单 3已接单 4派送中 5已完成 6已取消
